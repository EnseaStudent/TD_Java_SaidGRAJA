...
public class DynamicSprite extends SolidSprite{
    ...
    public boolean isAlive(DynamicSprite sprite) {return sprite.health > 0;};
    ...
    public void draw(Graphics g) {
        ...
        int ind = (int) (System.currentTimeMillis() / timeBetweenFrame % spriteSheetNumberOfColumn);
