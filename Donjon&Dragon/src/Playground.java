...
public class Playground {
    ...
    public Playground (String pathName, LevelManager levelManager){
        try{
            ...
            final Image imagePrincess = ImageIO.read(new File("./img/princess.png"));
            ...
            final int imagePrincessWidth = imagePrincess.getWidth(null);
            final int imagePrincessHeight = imagePrincess.getHeight(null);
                ...
                for (byte element : line.getBytes(StandardCharsets.UTF_8)){
                    switch (element){
                        ...
                        case 'R' : environment.add(new SolidSprite(columnNumber*imageRockWidth,
                            ...
                            break;
                        case 'A': environment.add(new Trap(columnNumber * imageTrapWidth,
                                lineNumber * imageTrapHeight, imageTrap, imageTrapWidth, imageTrapHeight));
                            break;

                        case 'P': environment.add(new Princess(columnNumber * imagePrincessWidth,
                                lineNumber * imagePrincessHeight, imagePrincess, imagePrincessWidth, imagePrincessHeight, levelManager));
                            break;
                    }
                    columnNumber++;
                }
